                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div class="text-truncate" data-i18n="Account Settings">Clientes</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div class="text-truncate" data-i18n="Account Settings">Vehículos</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="pages-account-settings-account.html" class="menu-link">
                                    <div class="text-truncate" data-i18n="Account">Registrar vehículo</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="pages-account-settings-connections.html" class="menu-link">
                                    <div class="text-truncate" data-i18n="Connections">Lista de vehículos</div>
                                </a>
                            </li>
                        </ul>
                    </li>
