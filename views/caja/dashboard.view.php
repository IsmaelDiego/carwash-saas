    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            ...
            <div class="d-flex gap-2">
                ...
                <button class="btn btn-sm btn-outline-secondary" onclick="cargarOrdenes()"><i class="bx bx-refresh me-1"></i>Actualizar</button>
            </div>
        </div>
        ...
        <div class="stats-bar">
            <div class="stat-pill border-0 shadow-sm" style="background: linear-gradient(135deg, #696cff, #8e91ff); color:#fff">
                ...
                <div><div class="sp-val" id="badgeActivas"><?= ($stats['EN_PROCESO'] ?? 0) + ($stats['POR_COBRAR'] ?? 0) ?></div><div class="sp-lbl text-white" style="opacity:0.8">Servicios Activos</div></div>
            </div>
            <div class="stat-pill">
                <div class="sp-icon bg-label-warning"><i class="bx bx-loader-circle"></i></div>
                <div><div class="sp-val text-warning" id="sEnProceso"><?= $stats['EN_PROCESO'] ?? 0 ?></div><div class="sp-lbl">Progreso</div></div>
            </div>
            <div class="stat-pill">
            ...
            <div class="stat-pill">
                ...
                <div><div class="sp-val text-primary" id="sIngresosHoy">S/ <?= number_format($stats['ingresos_hoy'] ?? 0, 0) ?></div><div class="sp-lbl">Vendido</div></div>
            </div>
        </div>
        ...
        <div class="pos-layout">
            ...
            <div style="padding-right:16px">
                ...
                <!-- Tabs de Navegación -->
                <div class="order-tabs mb-4 px-2">
                    <div class="order-tab active" data-filter="ACTIVAS" onclick="setFiltro('ACTIVAS', this)">Dashboard Operativo</div>
            ...
            <div class="pos-sidebar">
                ...
                <div class="ps-footer">
                    ...
                    <button class="btn btn-primary w-100 fw-bold rounded-pill shadow-sm" onclick="procesarCarrito()" id="btnVenta" disabled>
