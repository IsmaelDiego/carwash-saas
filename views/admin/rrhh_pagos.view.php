    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="row mb-4 g-3">
            <div class="col-sm-6 col-md-4 col-xl">
                <div class="card stat-prod-card shadow-sm h-100" style="border:1px solid #f0f0f0;">
                    <div class="card-body d-flex align-items-center gap-3 p-3">
                        <div class="stat-prod-icon bg-label-primary shadow-sm" style="border-radius:12px;width:48px;height:48px;display:flex;align-items:center;justify-content:center;font-size:1.4rem;"><i class="bx bx-money text-primary"></i></div>
                        <div><small class="text-muted fw-bold text-uppercase" style="font-size:0.65rem">Total Pagos</small>
            ...
            <div class="col-sm-6 col-md-4 col-xl">
                <div class="card stat-prod-card shadow-sm h-100" style="border:1px solid #f0f0f0;">
                    <div class="card-body d-flex align-items-center gap-3 p-3">
                        <div class="stat-prod-icon bg-label-success shadow-sm" style="border-radius:12px;width:48px;height:48px;display:flex;align-items:center;justify-content:center;font-size:1.4rem;"><i class="bx bx-check text-success"></i></div>
                        <div><small class="text-muted fw-bold text-uppercase" style="font-size:0.65rem">Pagados</small>
                            <div class="fw-bold text-success" id="stat_pagados" style="font-size:1.4rem">0</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl">
                <div class="card stat-prod-card shadow-sm h-100" style="border:1px solid #f0f0f0;">
                    <div class="card-body d-flex align-items-center gap-3 p-3">
                        ...
                        <div><small class="text-muted fw-bold text-uppercase" style="font-size:0.65rem">Retrasados</small>
                            <div class="fw-bold text-danger" id="stat_retrasados" style="font-size:1.4rem">0</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-xl">
                <div class="card stat-prod-card shadow-sm h-100" style="border:1px solid #f0f0f0;">
                    <div class="card-body d-flex align-items-center gap-3 p-3">
                        <div class="stat-prod-icon bg-label-info shadow-sm" style="border-radius:12px;width:48px;height:48px;display:flex;align-items:center;justify-content:center;font-size:1.4rem;"><i class="bx bx-wallet text-info"></i></div>
                        <div><small class="text-muted fw-bold text-uppercase" style="font-size:0.65rem">Monto Total Pagado</small>
                            <div class="fw-bold text-info" id="stat_monto_total" style="font-size:1.4rem">S/ 0</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-hover w-100 my-3" id="tbPagos" style="border-collapse: separate; border-spacing: 0;">
                    <thead class="bg-primary">
                        <tr>
                            ...
                            <th style="color: #f0f0f0;">Periodo</th>
                            <th style="color: #f0f0f0;">Fecha Prog.</th>
                            <th style="color: #f0f0f0;">Estado</th>
                            <th style="color: #ffffffff;">Monto</th>
...
<?php require VIEW_PATH . '/partials/rrhh_pago/filtros.php'; ?>
<script src="<?= BASE_URL ?>/public/js/admin/rrhh_pago.js"></script>
