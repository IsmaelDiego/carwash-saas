            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center mb-6">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-heading fw-bold">CARWASH-SAAS</span>
                </a>
              ...
              <!-- /Logo -->
              <h4 class="mb-1">La aventura empieza ahora 🚀</h4>
              <p class="mb-6">¡Haz que la gestion de tu negocio sea fácil y didáctica!</p>

              <form id="registerForm" class="mb-6" action="index.html">
                <div class="mb-6">
